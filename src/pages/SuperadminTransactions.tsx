    ...
    <Layout role="SUPERADMIN">
      <div className="p-6 md:p-12 w-full max-w-[1600px] mx-auto flex flex-col gap-10 bg-[#F2F2F2] min-h-screen">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-black text-black uppercase tracking-tighter">Historial Transaccional</h1>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="relative">
              ...
              <input 
                ...
                className="pl-12 pr-6 py-4 bg-white border border-black/5 rounded-2xl text-sm font-bold focus:outline-none focus:border-[#cc0066] transition-all w-64 shadow-sm"
              />
            </div>
