        ...
        >
          ...
          {step === 'FORM' ? (
            <div className="p-8 md:p-10">
              <div className="mb-8">
                <h2 className="text-2xl font-black text-black tracking-tighter uppercase">Comprar USD</h2>
                <p className="text-black/40 text-[10px] font-black uppercase tracking-[0.2em] mt-1">Recarga tu saldo en dólares PagoX</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  onClick={handleBuy}
                  className="w-full bg-[#000051] text-white py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-[#000051]/20 hover:bg-[#7F00DF] transition-all flex items-center justify-center gap-3 disabled:opacity-50 mt-4"
                >
                  {loading ? (
            ...
            <div className="p-12 flex flex-col items-center text-center">
              ...
              <button
                onClick={onClose}
                className="w-full bg-[#000051] text-white py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-[#7F00DF] transition-all shadow-lg"
              >
                Cerrar
              </button>
            </div>
